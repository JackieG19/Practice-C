...
// creating a new struct to work with Stack and Queue
...
STACKQ *qRoot;
void push(NODE*);
STACKQ *newQNODE = malloc(sizeof(STACKQ));

// push and pop
// display horizontal the order of the binary tree
// 10, 8, 15, 5, 9, 13, 17, 6, 20, 4, 7, 18
